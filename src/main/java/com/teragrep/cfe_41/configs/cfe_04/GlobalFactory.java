...
public final class GlobalFactory {
    ...
    public Global global() {
        if (!config.containsKey("cfe_04.global.truncate")) {
            throw new IllegalArgumentException("cfe_04.global.truncate not specified");
        }

        if (!config.containsKey("cfe_04.global.last_chance_index")) {
            throw new IllegalArgumentException("cfe_04.global.last_chance_index not specified");
        }
