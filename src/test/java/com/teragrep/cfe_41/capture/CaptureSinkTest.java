...
public class CaptureSinkTest {
    ...
    public void captureSinkTest() {
        ...
        // Build the expected JsonObject that CaptureSink creates
        JsonObjectBuilder expectedCaptureSinkBuilder = Json.createObjectBuilder();
        expectedCaptureSinkBuilder.add("target", "ip_address2");
        expectedCaptureSinkBuilder.add("port", "port2");
        expectedCaptureSinkBuilder.add("name", "flow2ip_address2port2protocol2");
        JsonObject expectedCaptureSink = expectedCaptureSinkBuilder.build();

        SinkRuleset expected = new SinkRuleset("flow2ip_address2port2protocol2", expectedCaptureSink);
